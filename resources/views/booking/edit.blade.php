...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Booking on {{ $booking->date }} </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('booking.update',$booking->id)}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="date" type="date" class="form-control @error('date') is-invalid @enderror" name="date" value="{{ $booking->date }}" required autocomplete="date" autofocus>
